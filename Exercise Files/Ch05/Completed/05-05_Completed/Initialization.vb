...
Public Class Initialization
    ...
    <CommandMethod("LICreateLine")> Public Sub cmdCreateLine()
        ...
        Using db As Database = HostApplicationServices.WorkingDatabase
            Try
                Dim spaceBlkId As ObjectId = db.CurrentSpaceId
                Dim point1 As New Point3d(0, 0, 0)
                Dim point2 As New Point3d(10, 10, 0)

                Using trans As Transaction = db.TransactionManager.StartTransaction
                    Try
                        Dim curSpaceBlock As BlockTableRecord = trans.GetObject(spaceBlkId, OpenMode.ForWrite)
